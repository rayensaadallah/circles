...
const SCREEN_ORDER = [
  ...
  { id: 'tally', name: 'Tally', make: t => <window.CC.ScreenTally t={t} /> },
  { id: 'hotseat', name: 'Hot Seat', make: t => <window.CC.ScreenHotSeat t={t} /> },
  { id: 'hotseat-verdict', name: 'Hot Seat verdict', make: t => <window.CC.ScreenHotSeatVerdict t={t} /> },
  { id: 'roundrobin', name: 'Round Robin', make: t => <window.CC.ScreenRoundRobin t={t} /> },
  { id: 'revote', name: 'Revote', make: t => <window.CC.ScreenRevote t={t} /> },
  { id: 'attribution', name: 'Attribution', make: t => <window.CC.ScreenAttribution t={t} /> },
