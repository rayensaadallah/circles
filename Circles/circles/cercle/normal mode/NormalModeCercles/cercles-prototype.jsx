...
function CerclesPrototype() {
  ...
  const screenMap = {
    ...
    normaltopic:     t => <window.CC.ScreenNormalTopicReveal t={t} onNav={onNav} />,
    normaltally:     t => <window.CC.ScreenNormalTally t={t} onNav={onNav} />,
    normalround:     t => <window.CC.ScreenNormalRound t={t} onNav={onNav} />,
    normalmindchange:t => <window.CC.ScreenNormalMindChange t={t} onNav={onNav} />,
  ...
  const flow = ['splash','onboarding','home','create','lobby','topic','debate','vote','tally','hotseat','hotseat-verdict','roundrobin','revote','attribution','score','results','normaltopic','normaltally','normalround','normalmindchange'];
